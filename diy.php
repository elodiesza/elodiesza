...
<body>
    ...
    <div class="container">
        ...
        <h3>This page pretty much demonstrates my introduction in the home page. When I need something and I can't find it anywhere, I make it :).</h3>
        <h2>LED world map</h2>
        <p>
            I moved to a new house and a blank white wall inspired me a world map concept. Indeed, I could find something similar to order online, but my idea
            was precise, and I am stubborn. I wanted something much more cooler : A cork world map where I could pin the places I have been to... with LEDs !
            Not a single time setting with wiring at the back, I wanted to make it possible to update it simply over time. That means : Simply pin a LED into
            the cork at the desired spot. No more action required. My idea and the concept behind it was clear. But would it work ? Nobody trusted me, but after
            some simple experiments... I demonstrated that it does !
        </p>
        <div style="display:flex; flex:1; justify-content:center; padding: 20px">
            <img src="img/art/DIY/demo.png" style="object-fit: contain; height:auto; max-width:40%;">
        </div>
        ...
        <h3>How it ended</h3>
        <p>
            I couldn't unfortunately finish the work due to my expatriation in Korea that happened in the mean time. I only missed a power plug, wires, an alternator 
            and weld the whole thing together so I could supply power to the full map. I am planning to do it again when I get to move to a bigger house in Korea.
        </p> </br></br>
        <h2>Deer jewelery holder</h2>
        <div style="display:flex; flex:1; justify-content:center; padding: 20px">
            <img src="img/art/DIY/deer7.png" style="object-fit: contain; height:auto; max-width:20%;">
        </div>
        <div class="gallery-div">
        ...
        <div style="display:flex; flex:1; justify-content:center; padding: 20px">
            <img src="img/art/DIY/nida4.png" style="object-fit: contain; height:auto; max-width:20%;">
        </div>
        <div class="gallery-div">
